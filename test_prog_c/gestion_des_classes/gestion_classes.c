        ...
        switch (choice){
            ...
            case 4:
                if (size > 0){
                    ...
                    FILE *reader = fopen("gestion_des_classes/classes.csv", "r");
                    char buffer[255];
            ...
            case 7:
                ...
                return 0;
            default:
                printf("Veuillez choisir une option du sous menu classe\n");
                goto classe_menu; 
        }
